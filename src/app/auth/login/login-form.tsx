    ...
    <>
      <div className="dark frappe min-h-screen flex items-center justify-center bg-ctp-base p-4">
        <div className="w-full max-w-145 bg-ctp-mantle backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
          ...
          {/* OAuth Providers */}
          <div className="flex flex-col text-ctp-base items-center gap-4 pb-8">
            <Button
      ...
      {isLoading && (
        <div className="fixed inset-0 bg-ctp-surface backdrop-blur-sm flex items-center justify-center z-50">
          <div className="w-16 h-16 border-4 border-ctp-lavender/40 border-t-ctp-mauve rounded-full animate-spin"></div>
        </div>
      )}
    </>
  );
